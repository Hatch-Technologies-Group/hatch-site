        ...
        {isLoading || !data ? (
          ...
          <>
            <ComplianceRow
              ...
              href="/broker/compliance?view=agents"
            />
            <ComplianceRow
...
function ComplianceRow({ label, value, pill, icon, tone = 'default', href }: ComplianceRowProps) {
  ...
  const content = (
    <div className="relative flex items-center justify-between rounded-xl border border-slate-100 p-3">
      <DebugLinkHint href={href} />
