...
export const supabaseEnabled = Boolean(supabaseUrl && supabaseAnonKeyEnv)
...
export const supabase =
  supabaseEnabled && supabaseUrl && supabaseAnonKeyEnv
    ? createClient(supabaseUrl, supabaseAnonKeyEnv)
    : ({
        auth: disabledAuth,
        from: disabledFrom,
...
export const supabaseAnonKey = supabaseEnabled && supabaseAnonKeyEnv ? supabaseAnonKeyEnv : ''
