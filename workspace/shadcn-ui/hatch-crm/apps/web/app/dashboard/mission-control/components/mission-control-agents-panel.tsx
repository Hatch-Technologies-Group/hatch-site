  ...
  return (
    <Card className="rounded-2xl border border-slate-100 bg-white p-4 shadow-sm" data-testid="mission-control-agents">
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <select
          className="w-[180px] rounded-md border border-slate-200 bg-white px-3 py-2 text-sm text-slate-900"
          value={riskFilter}
      ...
      <td className="py-3">
        <div className="flex flex-wrap gap-2">
          ...
          <Button asChild size="sm" variant="ghost">
            <Link href={`/dashboard/compliance?agent=${agent.agentProfileId}`}>Training</Link>
          </Button>
        </div>
      </td>
    </tr>
