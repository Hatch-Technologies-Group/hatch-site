import { BadRequestException, Controller, Get, Param, Query, Req, Res, UseInterceptors } from '@nestjs/common';
...
@Controller('clients/:tenantId/ai')
export class LegacyTenantInsightsController {
  ...
  async getTenantInsights(
    ...
    if (!targetTenant) {
      throw new BadRequestException('tenantId is required in path');
    }
